...
board.on("ready", function() {
    ...
    this.pinMode(2, five.Pin.OUTPUT); // LEFT digital pin to change direction
    this.pinMode(4, five.Pin.OUTPUT); // RIGHT digital pin to change direction
    this.pinMode(7, five.Pin.PWM);
    this.pinMode(6, five.Pin.PWM);
    this.pinMode(9, five.Pin.PWM);
    this.pinMode(10, five.Pin.PWM);
    this.pinMode(0, five.Pin.ANALOG); // analog pin for SHARP sensor 0A41SK F 3Z
...
*/
    ...
    socket.on("commandToArduinoFW", function(data) { // ko je socket ON in je posredovan preko connection-a: ukazArduinu (t.j. ukaz: išči funkcijo ukazArduinu)
        ...
        board.digitalWrite(2, 1); // na pinu 2 LEFT zapišemo vrednost LOW - direction forward
        board.digitalWrite(4, 1); // na pinu 4 RIGHT zapišemo vrednost HIGH - direction forward
        board.digitalWrite(3, 1); // na pinu 3 zapišemo vrednost HIGH
        board.digitalWrite(12, 0); // na pinu 3 zapišemo vrednost HIGH
    ...
    socket.on("commandToArduinoBK", function(data) { // ko je socket ON in je posredovan preko connection-a: ukazArduinu (t.j. ukaz: išči funkcijo ukazArduinu)
        ...
        // we switch on the relay and LED indicator
        board.digitalWrite(2, 0); // na pinu 2 zapišemo vrednost LOW - direction backward
        board.digitalWrite(4, 0); // na pinu 4 zapišemo vrednost HIGH - direction backward
        board.digitalWrite(3, 1); // na pinu 3 zapišemo vrednost HIGH
        board.digitalWrite(12, 0); // na pinu 12 zapišemo vrednost HIGH
    ...
    socket.on("commandToArduinoSpinL", function(data) { // ko je socket ON in je posredovan preko connection-a: ukazArduinu (t.j. ukaz: išči funkcijo ukazArduinu)
        ...
        // we switch on the relay and LED indicator
        board.digitalWrite(2, 0); // na pinu 2 LEFT zapišemo vrednost LOW - direction backward
        board.digitalWrite(4, 1); // na pinu 4 RIGHT zapišemo vrednost HIGH - direction forward
        board.digitalWrite(3, 1); // na pinu 3 zapišemo vrednost HIGH
        board.digitalWrite(12, 0); // na pinu 3 zapišemo vrednost HIGH
...
socket.on("commandToArduinoSpinR", function(data) { // ko je socket ON in je posredovan preko connection-a: ukazArduinu (t.j. ukaz: išči funkcijo ukazArduinu)
        ...
        // we switch on the relay and LED indicator
        board.digitalWrite(2, 1); // na pinu 2 LEFT zapišemo vrednost LOW - direction forward
        board.digitalWrite(4, 0); // na pinu 4 RIGHT zapišemo vrednost HIGH - direction backward
        board.digitalWrite(3, 1); // na pinu 3 zapišemo vrednost HIGH
        board.digitalWrite(12, 0); // na pinu 3 zapišemo vrednost HIGH
	...
	socket.on("ukazArduinuSTOP", function() {
        ...
        board.digitalWrite(3, 0); // na pinu 3 zapišemo vrednost LOW
        board.digitalWrite(12, 1); // na pinu 12 zapišemo vrednost LOW
        board.analogWrite(5, 0); // Naprej
        board.analogWrite(6, 0); // Nazaj
