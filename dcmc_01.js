...
var board = new firmata.Board("/dev/ttyACM0",function(){
    ...
    board.pinMode(26, board.MODES.INPUT); // LEFT digital pin from encoder
...
var refreshFrequency = 150; // frequency of control algorithm refresh in ms
...
var upperLimitPWM = 50; // zgornja meja vrednosti PWM - le ta določa koliko lahko največ kontrolni algoritem pošlje na PWM    
...
socket.on("commandToArduinoSpinR", function(data) { // ko je socket ON in je posredovan preko connection-a: ukazArduinu (t.j. ukaz: išči funkcijo ukazArduinu)
    ...
    board.digitalRead(24, function(value) { // LEFT funkcija se aktivira le, kadar se spremeni stanje; sicer bi bilo 1M čitanj na sekundo
        console.log("       Pin 24 active " + Date.now());
    ...
    board.digitalRead(26, function(value) { // LEFT funkcija se aktivira le, kadar se spremeni stanje; sicer bi bilo 1M čitanj na sekundo
        console.log("               Pin 26 active " + Date.now());
